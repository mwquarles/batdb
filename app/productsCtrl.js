app.controller('productsCtrl', function ($scope, $modal, $filter, Data) {
    ...
    $scope.open = function (p,size) {
        ...
        modalInstance.result.then(function(selectedObject) {
            if(selectedObject.save == "insert"){
                ...
                p.rmanum = selectedObject.rmanum;
                p.rmadesc = selectedObject.rmadesc;
                p.rmadate = selectedObject.rmadate;
 ...
 $scope.columns = [
                    ...
                    {text:"RMA Num",predicate:"rmanum",sortable:true},
                    {text:"RMA Description",predicate:"rmadesc",sortable:true},
                    {text:"RMA Date",predicate:"rmadate",sortable:true},
